...
Computer Science graduate passionate about **Machine Learning, Artificial Intelligence, Data Analytics, and Backend Development**. I enjoy building intelligent systems, automation solutions, and real-world applications while continuously learning modern technologies and solving challenging problems.

- 🌱 Currently learning **MongoDB, Linux, RabbitMQ**
- 💻 Interested in **Software Development, Backend Engineering, AI & Machine Learning**
- 📚 Currently improving my **Data Structures & Algorithms** skills through consistent problem solving
...
- 📖 Learning **MongoDB** and **Linux Administration**
- ⚡ Exploring **RabbitMQ** and Backend Technologies
- 🧠 Solving **Data Structures & Algorithms** problems
- 🚀 Building real-world software applications using **Python** and **Flask**
...
<p align="left">
  ...
  <img src="https://www.vectorlogo.zone/logos/rabbitmq/rabbitmq-icon.svg" width="48"/>
...
|----------|-------------|------------|
| 📄 **Intelligent Research Paper Summarization & Formatting System** | AI-powered application that summarizes research papers, formats academic documents, generates insights, and creates visualizations. | Python, NLP, Streamlit |
| 🏫 **KUCampusConnect** | Web-based system for automating university exam scheduling, room allocation, and student management. | Node.js, Express.js, MongoDB |
| ✅ **FocusFlow** | Productivity and habit tracking web application for managing tasks, habits, and daily progress. | Flask, SQLAlchemy |
...
Computer Science graduate passionate about **Machine Learning, Artificial Intelligence, Data Analytics, and Backend Technologies**. I enjoy building intelligent systems, automation solutions, and data-driven applications while continuously learning modern technologies.
